...
BIOMES = {
    ...
    "Степи": ["Бескрайние равнины", "Кочевые лагеря", "Древние курганы", "Вихревые тропы"],
    "Тундра": ["Ледяные равнины", "Замерзшие озёра", "Вечные снега", "Заброшенные участки исследований"],
    "Вулканические земли": ["Огненные ущелья", "Лавовые поля", "Кислотные озёра", "Пепельные равнины"],
    "Острова": ["Проклятые берега", "Затопленные пещеры", "Лазурные заливы", "Разрушенные маяки"],
    "Подземелья": ["Тёмные галереи", "Грибные рощи", "Подземные реки", "Заброшенные тюрьмы"]
}
